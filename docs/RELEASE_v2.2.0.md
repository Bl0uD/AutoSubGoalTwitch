...
- **Couleurs personnalisées** avec saisie CSS directe (texte, ombre, contour)
...
### 📁 Overlays Unifiés
- **4 overlays dynamiques** (vs 8 fichiers avant)
- **50% de réduction** du nombre de fichiers
- **~3100 lignes** de code dupliqué éliminées
- **Configuration temps réel** active par défaut sur tous les overlays
- **Plus de confusion** entre versions statiques/dynamiques
