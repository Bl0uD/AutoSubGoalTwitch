...
Auteur: Bl0uD
Date: 02/12/2025
Version: 3.1.0 (Architecture DI + StateManager)
"""
...
def script_description():
    ...
    return """<h2>🎮 SubCount Auto v3.1.0</h2>"""
...
def script_load(settings):
    ...
    log_message("🎬 Script OBS SubCount Auto v3.1.0 avec Auto-Update chargé", level="info")
